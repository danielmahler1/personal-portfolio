...
export default function ResumePage() {
  return (
    ...
    <div className="flex flex-col h-dvh overflow-hidden md:h-auto md:overflow-auto bg-black text-white">
      {/* 
      ...
      */}
      <main className="flex-grow p-4 sm:p-8 md:p-12 flex flex-col items-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-mono mb-4 sm:mb-6">Resume</h1>
        ...
        */}
        <div className="w-[85vw] max-w-3xl bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg flex items-center justify-center">
          <Image
            src="/resume.svg"
            alt="Resume"
